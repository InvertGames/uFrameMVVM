...
namespace Invert.MVVMTest {
    ...
    public class DailyWorkoutResultsScreenControllerBase : FormController {
        ...
        public override void Initialize(ViewModel viewModel) {
            this.InitializeDailyWorkoutResultsScreen(((DailyWorkoutResultsScreenViewModel)(viewModel)));
        }
        
        public virtual DailyWorkoutResultsScreenViewModel CreateDailyWorkoutResultsScreen() {
            return ((DailyWorkoutResultsScreenViewModel)(this.Create()));
        }
        
        public override ViewModel CreateEmpty() {
            return new DailyWorkoutResultsScreenViewModel(this);
        }
        
        public virtual void InitializeDailyWorkoutResultsScreen(DailyWorkoutResultsScreenViewModel viewModel) {
        }
        
        public virtual void Register(DailyWorkoutResultsScreenViewModel viewModel) {
        }
    }
}
